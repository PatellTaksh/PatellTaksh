...
Aspiring Data Analyst with practical experience in end-to-end data analytics, including web scraping, ETL, SQL, PostgreSQL, and Power BI. Passionate about turning raw data into meaningful insights through interactive dashboards and data-driven decision-making.
...
Database: PostgreSQL   
Core Skills: Data Analysis | Data Cleaning | Exploratory Data Analysis (EDA) | Data Visualization | Data Modeling | ETL | Web Scraping | Dashboard Development | DAX | Data Transformation
